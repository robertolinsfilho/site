...
session_start();
$cpf= $_SESSION['cpf'];  
$result_usuario = "SELECT * from dadosprincipais where cpf ='$cpf'";
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" integrity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="anonymous"></script>
  ...
  <section id="form3" class="d-flex align-items-center"> 
    <div class="container" data-aos="zoom-out" data-aos-delay="200">
     ...
     <br><br><br>
     <form action="incluirformendereco.php" method="POST">
       <div class="row">
       
         <div class="col">
            <label style="color: blue; font-family:'Poppins', sans-serif;  " for="LabelNome">Nome Completo</label>
           <input type="text" name="nome" class="form-control" value="<?php echo $row_usuario['nome']?>" placeholder="Nome Completo" readonly>
         </div>
       ...
       <div class="row">
         ...
         <div class="col">
           ...
           <input type="text" name="cpf_titular" value="<?php echo $row_usuario['cpf']?>"class="form-control"  placeholder="Nome Completo" readonly>
         </div>
        
         <div class="col">
            <label style="color: blue; font-family:'Poppins', sans-serif;  " for="LabelNome">CNS-CARTAO SUS </label>
           <input type="text" name="nome"class="form-control"  value="<?php echo $row_usuario['nome']?>" placeholder="Nmuero do cartão" readonly>
         </div>
         <div class="col">
            <label style="color: blue; font-family:'Poppins', sans-serif;  " for="LabelNome">Data Nascimento</label>
           <input type="text" name="datas" id="data"class="form-control" value="<?php echo $row_usuario['datas']?>" placeholder="DD/MM/ANO" readonly>
         </div>
