...
if(isset($row_usuario1)){
  header('Location: login2.php?email='.$_SESSION['emailplataforma'].'&plano='.$_SESSION['plano1'].'&cpf='.$_SESSION['cpf1']);
...
<script src="https://code.jquery.com/jquery-3.3.1.slim.min.js" integrity="sha384-q8i/X+965DzO0rT7abK41JStQIAqVgRVzpbzo5smXKp4YfRvH+8abtTE1Pi6jizo" crossorigin="anonymous"></script>
     ...
     <form action="contrato.php" method="POST">
       <div class="row">
         ...
         <div class="col-md-4">
           ...
           <input type="text" class="form-control" name="email" value = "<?php echo $_SESSION['emailplataforma'] ?>" readonly>
         </div>
         <div class="col-md-4">
            <label style="color: blue; font-family:'Poppins', sans-serif;  " for="LabelNome">Plano</label>
           <input type="text" class="form-control" name="plano"value = "<?php echo $_SESSION['plano1'] ?>" name="plano"  readonly>
         </div>
         <div class="col-md-4">
            <label style="color: blue; font-family:'Poppins', sans-serif;  " for="LabelNome">Cpf</label>
           <input type="text" class="form-control" name="cpf"  value = "<?php echo $_SESSION['cpf1'] ?>" readonly>
         </div>
         <br>
       </div>
       <br>
  ...
  <p></p>
    ...
    <h3>Numero Dependentes: <?php echo $cont?> </h3>
    <br><br><br>
    <?php
   if($_SESSION['plano1'] === 'UNIDENTISVIPBOLETO'){
     $preco = 40;
   }elseif($_SESSION['plano1'] === 'UNIDENTISVIPUNIVERSITÁRIOCARTAO'){
      $preco = 21.90;
   }else{
      $preco = 20;
   }
...
<h2>Preço Final R$: <?php echo $preco?></h2>
