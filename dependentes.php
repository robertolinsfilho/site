...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" integrity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="anonymous"></script>
     ...
     <a href="index.html"><img style="width: 38%; height: 25%;"src="./assets/img/LOGOUNIDENTIS222.png" /></a>
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li><a href="https://unidentis.intelite.com.br/panel/dashboard">Rede Credenciada</a></li>
  ...
  <section id="form2" class="d-flex align-items-center"> 
    <div class="container" data-aos="zoom-out" data-aos-delay="200">
     ...
     <br><br><br>
     <form action="enviodependentes.php" method="POST">
       <div class="row">
         <div class="col">
       ...
       <div class="row">
         ...
         <div class="col">
           ...
           <input type="text" name="cns"class="form-control" placeholder="Nmuero do cartão" required>
         </div>
       ...
       <br>
        ...
        <div class="row">
           ...
           <input type="text" name="mae" class="form-control" minlenght="20"  placeholder="Nome da Mae" required>
        </div>
