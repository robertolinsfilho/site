 ...
 <header id="header" class="fixed-top">
  ...
  <section id="hero2"  class="d-flex align-items-center">
    <div class="container" data-aos="zoom-out" data-aos-delay="100">
      <h1>Rede<span> Credenciada</span>
      </h1>
      <br>
  
    <iframe width="100%" height="370" src="http://corporativo.unidentis.com.br/sys/rede_atendimento/rede_atendimento.aspx?modal=1" frameBorder="0"></iframe>
