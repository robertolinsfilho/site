...
VALUES ('$_SESSION[cpf]','$_SESSION[nome]','$_SESSION[email]','$boleto','$_SESSION[preco]')";
$result = mysqli_query($conexao, $sql);
$row = mysqli_fetch_assoc($result);


$sql1 = "INSERT INTO dadospessoais (nome,email,senha,cpf,vendedor,celular,estado,plano,tipocliente,sus)
VALUES ('$nome', '$email','$_SESSION[senha]', '$_SESSION[cpf]','$_SESSION[vendedor]','$_SESSION[celular]','$_SESSION[estado]','$_SESSION[plano]','$_SESSION[tipocliente]','$_SESSION[sus]')";
