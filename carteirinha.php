<?php
$url ='http://unidentis.s4e.com.br/v2/api/associados?token=RWNTF7PUC87KRYRTVNFGP8XNYWJ4DQC4XWCGSHPW2F9FCURP82&cpfAssociado=07453980496';
...
<head>
  ...
  <link rel="canonical" href="http://unidentis.com.br/carteirinha" />
  <!-- Vendor CSS Files -->
...
<div class="modal fade" id="exampleModal1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container" data-aos="zoom-out" data-aos-delay="100">
      <h1>Carteirinha Digital <span>Unidentis</span>
      </h1>
...
<?php
		...
		?>
<form method="POST" action="resultadocarteirinha.php">

 
<input name="cpf" placeholder="Apenas Números"  class="form-control"/> <br>

<br>

<button class="btn btn-primary" value="1" name="opcao" class="form-control" type="submit">Pesquisar</button>
