...
<body>
  ...
  <section id="hero"  class="d-flex align-items-center">
    <div class="container" data-aos="zoom-out" data-aos-delay="100">
      <h1>Bem Vindo a <span>Unidentis</spa>
      </h1>
      <h2>Escolha seu vendendor  :</h2>
      <form action="vendedor.php" method="POST">
      <div >
       <select name="vendedor" class="form-control col-sm-4">
      ...
      <br> 
          ...
          <input type="submit" class="btn btn-primary" name="tipocliente" value="Pessoa Fisica"/>
          <input type="submit" class="btn btn-primary" name="tipocliente" value="Pessoa Juridica"/>
          <input type="submit" class="btn btn-primary" name="tipocliente" value="Servidor Publico"/>
          <input type="submit" class="btn btn-primary" name="tipocliente" value="Incluir Vendedor"/>
      </form>
