...
<br><br><br><br>
<h1>Dados do <span>Cartão</span> </h1><br>
<img style="width:30%; " src="assets/img/cartao.png" />
<div class="row">
         <div class="col">
            
           <input type="text"   name="nomecartao" class="form-control" placeholder="Nome (como esta no Cartão)"required>
         </div>
         <div class="col">
          
           <input type="text" class="form-control" name="cartao" id="cartao" placeholder="numero do cartão"required>
         </div>
</div><br>
<div class="row">
         <div class="col">
          
           <input type="text" class="form-control" id="mes"name ="mes"placeholder="Mês"required>
         </div>
         <div class="col">
