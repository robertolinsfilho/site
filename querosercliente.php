...
<h1>Para <span>Você</span></h1>
    <br />
    <h2>Preencha os dados abaixo e logo entraremos em contato.</h2>

    <br />
    <form action="http://app.convertee.com/api/v2" method="post">
        <input type="hidden" name="uid"  value="UA-23732200-5" />
        <input type="hidden" name="ufrm" value="UFRM-5c5a285b6c9db3.77133502" />
        ...
        <div class="form-group">
            <label class="control-label">Telefone / Celular / WhatsApp</label>
            <input type="text" name="phone" value="" class="form-control" REQUIRED>
        </div>

        <button type="submit" class="btn btn-primary">Solicitar atendimento</button>
...
<div class="col-lg-6">
    ...
    <h1>Para Sua<span> Empresa</span></h1>
    <br />
    <h2>Preencha os dados abaixo e logo entraremos em contato.</h2>
    ...
    <div class="form-group">
            <label style="font: poppins;" class="control-label">Nome:</label>
        ...
        <div class="form-group">
			...
			<button type="submit" class="btn btn-primary" >Solicitar atendimento</button><br><br>
		</form>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-5 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="https://unidentis.s4e.com.br/SYS/?TipoUsuario=1">Portal do Beneficiario</a></li>
          ...
          <div class="col-lg-4 col-md-5 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> Endereço: Av. Maximiano Figueiredo, 94 - Centro, João Pessoa - PB</li>
          ...
          <a  <a href="https://apps.apple.com/br/app/unidentis-associado/id1368673470"> <img style="width: 48%;"src="assets/img/appstore-button.png"/></a>
