...
<script src="https://code.jquery.com/jquery-3.3.1.slim.min.js" integrity="sha384-q8i/X+965DzO0rT7abK41JStQIAqVgRVzpbzo5smXKp4YfRvH+8abtTE1Pi6jizo" crossorigin="anonymous"></script>
  ...
  <section id="form2" class="d-flex align-items-center"> 
    <div class="container" data-aos="zoom-out" data-aos-delay="200">
     ...
     <br><br><br>
     <form action="enviodadospessoais.php" method="POST">
       <div class="row">
         <div class="col">
            <label style="color: blue; font-family:'Poppins', sans-serif;  " for="LabelNome">CPF:</label>
           <input type="text" name="cpf" class="form-control" value="<?php echo $_SESSION['cpf']?>" readonly>
         </div>
         <div class="col">
       ...
       <div class="row">
         <div class="col">
           ...
           <input type="text" name="nome" class="form-control" value="<?php echo $_SESSION['nome']?>" placeholder="Nome Completo" readonly>
         </div>
         <div class="col">
            <label style="color: blue; font-family:'Poppins', sans-serif;  " for="LabelNome">Celular:</label>
           <input type="text" name="celular"class="form-control" value="<?php echo $_SESSION['celular']?>" readonly>
         </div>
         <div class="col">
       ...
       <br>
        ...
        <div class="col">
           ...
           <input type="text" name="fixo" class="form-control"  placeholder="Telefone Fixo" required>
        </div>
        </div>        
       <br>
