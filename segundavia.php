...
<body>
  ...
  <section id="hero"  class="d-flex align-items-center">
    <div class="container" data-aos="zoom-out" data-aos-delay="100">
      <h1>Segunda Via<span> de Boleto</spa>
      </h1>
       <h2>Preencha com seu CPF :</h2>
      <div class="col-lg-6">
   

   <form name="form1" method="get" target='_blank' action="http://corporativo.unidentis.com.br/SYS/Associados/Acesso.aspx">

       <div class="form-group">
       
           <input type="text" name="ID" class="form-control" id="ID" placeholder="Apenas Números">
       </div>
  ...
  <section id="txtform1" class="d-flex align-items-center" >
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-5 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="https://unidentis.s4e.com.br/SYS/?TipoUsuario=1">Portal do Beneficiário</a></li>
