...
<section id="form1" class="d-flex align-items-center"> 
 ...
 <br>
        ...
        <label style="color: blue; font-family:'Poppins', sans-serif;  " for="LabelNome">RG frente:</label>
        <div class="input-group mb-3">
            <div class="input-group-prepend">
                <span class="input-group-text">Arquivo</span>
            </div>
            <div class="custom-file">
                <input type="file" class="custom-file-input" multiple="multiple" name="arquivo[]" id="inputGroupFile01"required>
                <label class="custom-file-label" for="inputGroupFile01">Selecionar Arquivo</label>
            </div>
            </div>
            <label style="color: blue; font-family:'Poppins', sans-serif;  " for="LabelNome">RG Verso:</label>
            <div class="input-group mb-3">
            <div class="input-group-prepend">
                <span class="input-group-text">Arquivo</span>
            </div>
            <div class="custom-file">
                <input type="file" class="custom-file-input" multiple="multiple" name="arquivo1[]" id="inputGroupFile02"required>
                <label class="custom-file-label" for="inputGroupFile01">Selecionar Arquivo</label>
            </div>
            </div>
            <label style="color: blue; font-family:'Poppins', sans-serif;  " for="LabelNome">Comprovante de Residência:</label>
            <div class="input-group mb-3">
            <div class="input-group-prepend">
                <span class="input-group-text">Arquivo</span>
            </div>
            <div class="custom-file">
                <input type="file" class="custom-file-input" multiple="multiple" name="arquivo2[]" id="inputGroupFile03"required>
                <label class="custom-file-label" for="inputGroupFile01">Selecionar Arquivo</label>
            </div>
            </div>
            <label style="color: blue; font-family:'Poppins', sans-serif;  " for="LabelNome">RG Verso:</label>
            ...
            <div class="custom-file">
                <input type="file" class="custom-file-input" multiple="multiple" name="arquivo3[]" id="inputGroupFile04"required>
                <label class="custom-file-label" for="inputGroupFile01">Selecionar Arquivo</label>
            </div>
            </div>
            ...
            <div class="custom-file">
                <input type="file" class="custom-file-input" multiple="multiple" name="arquivo4[]" id="inputGroupFile05"required>
                <label class="custom-file-label" for="inputGroupFile01">Selecionar Arquivo</label>
            </div>
            </div>
