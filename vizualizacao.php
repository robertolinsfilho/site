    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
         ...
         HOSPITAL RIO GRANDE , N° 754, TIROL, NATAL- RN, CEP - 59020-100.<BR><BR>
...
<style>
  ...
  <section id="hero"  class="d-flex align-items-center">
    ...
    <img style ="width:30%;"src="./fotos/<?php echo $cpf?>.jpg" />
<a href="./fotos/<?php echo $cpf?>.jpg" download="1.jpg"><button class="btn btn-primary">Clique para Baixar</button></a>
<br><br>
<img style ="width:30%;" src="2.jpg" />
<a href="2.jpg" download="2.jpg"><button class="btn btn-primary">Clique para Baixar</button></a>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-5 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="https://unidentis.s4e.com.br/SYS/?TipoUsuario=1">Portal de Beneficiario</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="https://unidentis.s4e.com.br/SYS/?TipoUsuario=2">Portal Corporativo</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="https://unidentis.s4e.com.br/SYS/?TipoUsuario=6">Portal do Corretor</a></li>
            </ul>
          </div>
          ...
          <div class="col-lg-4 col-md-5 footer-links">
            <h4>SAC Unidentis</h4>
            <ul>
              <li><i class="bx bx-chevron-right"></i> (83) 3044-3000</li>
              <li><i class="bx bx-chevron-right"></i> Email:</li>
              <li><i class="bx bx-chevron-right"></i> contato@unidentis.com.br</li>
              <li><i class="bx bx-chevron-right"></i> Endereço:</li>
              <li><i class="bx bx-chevron-right"></i> Av. Maximiano Figueiredo, 94 - Centro, João Pessoa - PB</a></li>
            </ul>
          </div>

          <div class="col-lg-4 col-md-5 footer-links">
          <img src="imagens/logo.PNG" /><br>
            <h2 style="text-align: center;">Baixe já!</h2>
           <img style="width: 48%;"src="assets/img/appstore-button.png"/>
           <img  style="width: 48%;" src="assets/img/googleplay-button.png"/>
          </div>
